...
# Ethereum prompts
PARSE_TRANSFER_PROMPT = (
    "Parse the following user request to extract token transfer details:\n\n"
    'User Request: "{user_request}"\n\n'
    "Extract the following information:\n"
    "1. Amount to transfer (numeric value)\n"
    "2. Token ticker/symbol (e.g., ETH, USDC, etc.)\n"
    "3. Destination address (either hex address or ENS name)\n\n"
    "If any information is missing or unclear, indicate that in your response."
    "Format your response as a JSON object with amount, token, and destination fields."
)
