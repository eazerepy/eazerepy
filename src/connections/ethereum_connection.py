...
class EthereumConnection(BaseConnection):
        ...
        if not self._web3:
            for attempt in range(3):
                try:
                    ...
                    logger.info(
                        f"Connected to Ethereum network with chain ID: {chain_id}"
                    )
                    break
    ...
    def register_actions(self) -> None:
        ...
        self.actions = {
            ...
            "get-balance": Action(
                ...
                parameters=[
                    ActionParameter(
                        "address", False, str, "Address to check balance for (optional)"
                    ),
                    ActionParameter(
                        "token_address",
                        False,
    ...
    def swap(
        ...
        try:
            ...
            return (
                f"Swap transaction sent!(allow time for scanner to populate it):\n"
